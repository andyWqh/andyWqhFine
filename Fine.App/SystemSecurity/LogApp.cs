...
using Fine.Repository.SystemSecurity;
using System;
...
using andyWqhCommon.Net;

namespace Fine.App.SystemSecurity
{
   public class LogApp
    {
        ...
        public void WriteDbLog(bool result, string resultLog)
        {
            ...
            logEntity.F_Id = CommonHelper.GuId();
            logEntity.F_Date = DateTime.Now;
            logEntity.F_Account = OperatorProvider.Provider.GetCurrent().UserCode;
            logEntity.F_NickName = OperatorProvider.Provider.GetCurrent().UserName;
            logEntity.F_IPAddress = Net.GetIP;
